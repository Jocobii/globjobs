...
import { urlIntegration, openNewTab } from '../../utils/funcs';
...
export default function ListDocuments2({
  ...
  const handleDragStart = (e: React.DragEvent, node: NodeModels) => {
    e.dataTransfer.setData('text', JSON.stringify(node.id));
  };
