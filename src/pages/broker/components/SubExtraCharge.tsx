...
import { useMaterial, Material } from '../hooks/materials';

type Props = {
  handlerAddCharge: (formValues: FieldValues) => void;
};

export default function SubExtraCharge({ handlerAddCharge }: Readonly<Props>) {
  ...
  const {
    ...
    resolver: yupResolver(schemaExtra) as any,
  });
