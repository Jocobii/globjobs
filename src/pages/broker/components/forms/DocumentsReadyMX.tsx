...
import { usePedimentoValidation } from '../../services/verifyPedimento';
import { useShippingStockAndTrace } from '../../services/verifyShippingOrder';
import { useShipperValidation } from '../../services/verifyTransit';
...
export default function DocumentsReadyMX({
  submitFrom,
  onClose,
  operationId,
  skipStepUsa,
