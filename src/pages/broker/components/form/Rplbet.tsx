...
import { useRplbet } from '@/pages/broker/hooks/rplbet';
...
export function Rplbet({ handleClose, handleCreateOperation }: Readonly<Props>) {
  ...
  const [createOperation, { data, loading }] = useRplbet();
