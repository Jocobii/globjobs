...
export const brokerEs = {
  ...
  borderCrossing: 'Operación USA - MX',
  ...
  borderCrossingUsaMx: 'Operación USA - MX',
  ...
  borderCrossingError: 'error al guardar operación fronteriza',
  borderCrossingSuccess: 'operación fronteriza guardado correctamente',
  ...
  table: {
    ...
    borderCrossingDate: 'Fecha de operación fronteriza',
  ...
  cardsMonitor: {
    ...
    borderHeals: 'Operación Fronteriza',
